...
/**
 * PaginatedAssetAdministrationShell
 */
...
public class PaginatedAssetAdministrationShell extends PagedResult<AssetAdministrationShell> {
	...
	public String toString() {
		...
		sb.append("class PaginatedAssetAdministrationShell {\n");

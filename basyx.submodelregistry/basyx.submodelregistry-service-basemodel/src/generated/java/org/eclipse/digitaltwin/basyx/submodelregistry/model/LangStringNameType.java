...
public class LangStringNameType implements Serializable {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link LangStringNameType#LangStringNameType(String, String)}
   */
  @Deprecated
   ...
   */
  public LangStringNameType(String language, String text) {

...
public class AbstractLangString implements Serializable {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link AbstractLangString#AbstractLangString(String)}
   */
  @Deprecated
   ...
   */
  public AbstractLangString(String language) {

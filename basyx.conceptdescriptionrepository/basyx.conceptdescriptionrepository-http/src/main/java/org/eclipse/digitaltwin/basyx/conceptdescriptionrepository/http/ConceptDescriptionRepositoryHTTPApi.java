...
public interface ConceptDescriptionRepositoryHTTPApi {
  ...
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "Requested Concept Descriptions", content = @Content(mediaType = "application/json", schema = @Schema(implementation = GetConceptDescriptionsResult.class))),

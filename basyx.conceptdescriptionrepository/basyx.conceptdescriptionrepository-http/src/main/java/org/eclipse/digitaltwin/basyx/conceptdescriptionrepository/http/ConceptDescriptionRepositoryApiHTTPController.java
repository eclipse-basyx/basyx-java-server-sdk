...
public class ConceptDescriptionRepositoryApiHTTPController implements ConceptDescriptionRepositoryHTTPApi {
  ...
  @Override
  public ResponseEntity<PagedResult> getAllConceptDescriptions(@Valid String idShort,
    @Valid Base64UrlEncodedIdentifier isCaseOf, @Valid Base64UrlEncodedIdentifier dataSpecificationRef,
    ...
    CursorResult<List<ConceptDescription>> filteredResult = repoFilter.filter(idShort, isCaseOfReference,
      dataSpecificationReference, pInfo);
  ...
  private Reference getReference(String serializedReference) {
    ...
    try {
      ...
      throw new IllegalArgumentException(
        "Passed reference string " + serializedReference + " is not a valid serialized reference");
    }
  }

...
public class AbacSchema {
    ...
    public String toString() {
        ...
        sb.append(AbacSchema.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("allRules");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AbacSchema) == false) {
            return false;
        }
        AbacSchema rhs = ((AbacSchema) other);

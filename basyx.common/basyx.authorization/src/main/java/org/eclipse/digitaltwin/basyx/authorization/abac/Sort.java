...
public class Sort {
     ...
     * @param id
     */
    public Sort(Sort.Id id) {
        super();
        this.id = id;
    }

    @JsonProperty("id")
    public Sort.Id getId() {
        return id;
    }

    @JsonProperty("id")
    public void setId(Sort.Id id) {
        this.id = id;
    }
    ...
    public enum Id {
        ...
        private final static Map<String, Sort.Id> CONSTANTS = new HashMap<String, Sort.Id>();

        static {
            for (Sort.Id c: values()) {
        ...
        @JsonCreator
        public static Sort.Id fromValue(String value) {
            Sort.Id constant = CONSTANTS.get(value);
            if (constant == null) {
